...
function setupFormHandler() 
{
    ...
    form.addEventListener('submit', async e => 
    {
        ...
        const relationExists = relations.some( r => r.studentId === newRelation.studentId && r.subject_id === newRelation.subject_id);
        if (relationExists){
            alert('Esta relacion ya existe entre estudiante y materia.');
            return;
        }
        try 
        {
